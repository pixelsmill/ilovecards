    ...
    <div style={{ fontFamily: "var(--font-spectral), serif" }}>
      ...
      >
        ...
        <p className="text-base sm:text-lg max-w-md mb-10 leading-relaxed" style={{ color: "#9B9289" }}>
          Organisez vos passions en collections de cartes. Parcourez-les librement. Activez la méthode SM-2 — répétition à intervalles optimisés, validée en sciences cognitives — pour ancrer durablement ce qui compte.
        </p>
