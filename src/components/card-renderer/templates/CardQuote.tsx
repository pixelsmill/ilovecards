...
export default function CardQuote({ notion, size, accentColor = '#7A2E3A' }: TemplateProps) {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: `color-mix(in srgb, ${accentColor} 12%, white 88%)`, color: '#1A1814' }}
    >
      <div className={isThumb ? 'p-1.5' : isFull ? 'p-8' : 'p-3'}>
        <div
          ...
          style={{ fontFamily: "var(--font-spectral), serif", color: accentColor, opacity: 0.85 }}
          aria-hidden
        >
          &ldquo;
        </div>
